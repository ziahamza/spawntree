...
- View environment details with service cards showing status, ports, and proxy URLs
- Stream logs in real-time from any environment with service filtering
- Start, stop, and restart environments from the browser
- Add local folders to link repos, with automatic git remote detection (GitHub, GitLab, Bitbucket)
...
- `DESIGN.md` with complete design system (gitenv-inherited almond/cacao dark theme)
