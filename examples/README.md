...
Real-world project configurations for spawntree. Each example is a
spawntree.yaml and README showing how spawntree fits into a specific stack.
...
- **project-gamma**: Tested end-to-end. Host (PGlite) + Studio (Vite) start via
  daemon, healthchecks pass.
- **project-alpha**: Awaiting Phase 3 (shared Postgres/Redis Docker
  infrastructure).
